...
public class TypeCheckTest {
	 ...
	 */
	 ...
	 String input = "prog int k = 2; int k=123; int k=415;";
	 thrown.expect(SemanticException.class);
	 typeCheck(input);
	 }
	 ...
	 String input = "prog image [10,11] abcd <- @(1234);"; 
	 typeCheck(input);
	 }
	 
	 @Test
	 public void test8() throws Exception {
	 String input = "prog url imgurl=\"https://www.facebook.com\";"; 
	 typeCheck(input);
	 }
